...
module.exports.Dashing = function Dashing(options) {
  var dashing = {};
  options = options || {};
  dashing.root = options.root || path.resolve(__dirname, '../../..');
  ...
  console.log(path.resolve(dashing.root, './assets/javascripts'));
  dashing.mincer.environment.appendPath(path.resolve(dashing.root, './assets/javascripts'));
  dashing.mincer.environment.appendPath(path.resolve(dashing.root, './assets/stylesheets'));
  dashing.mincer.environment.appendPath(path.resolve(dashing.root, './assets/fonts'));
  dashing.mincer.environment.appendPath(path.resolve(dashing.root, './assets/images'));
  dashing.mincer.environment.appendPath(path.resolve(dashing.root, './widgets'));
